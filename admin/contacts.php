...
<section class="data-main-sec">
	...
	<section class="data-content-bx">
		<div class="heading-dv">
			<div class="left">
				<a href="contacts.php" class="fn common-btn">Assign Permission</a>
				<a href="contacts-view.php" class="fn">View</a>
			</div>
			<div class="right">
				<a href="#" class="gray-btn">Save</a>
